						...
						<td >
							<tr><td class="menu" class="tgl"><font class="txtMenu"><center><a href=""><a href="Administradora.php"> Administradora</center></font></td><td rowspan="5" >
								...
								<table border='0' align=‘center'>
										<tr><td align='left'>
										Nome: <input ;" type="text" name="nomec" style="margin-left: 52px;">
										<br>Bairro: <input type="text" name="bairroc" style="margin-left: 51px;">
										<br>Endereço: <input type="text" name="enderecoc" style="margin-left: 31px;">
										<br>Número: <input type="text" name="numeroc" style="margin-left: 39px;">
										<br>Complemento: <input type="text" name="complementoc" style="margin-left: 1px;">
										
										
										<br><br><input type="submit" value="Cadastrar Condominio">
										</td></tr>
										</table>
										</form> 
